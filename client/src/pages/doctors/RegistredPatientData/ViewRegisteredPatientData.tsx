...
import { Box, Checkbox, CircularProgress, Divider, IconButton, Modal, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material';
      ...
      <TableHead sx={{backgroundColor:'#103939',color:'white'}}>
        ...
        <TableBody>
          {tableLoading ? (
            ...
            patientData.patientInfo.healthRecords?.map((file:IHealthRecord, index:number) => (
              <TableRow
                  role="checkbox"
                  hover
