...
const MedicineCrudGrid: React.FC<MedicineCrudGridProps> = ({
  ...
  dependent
   ...
   const link = `${config.pharmacyURL}/doctor/manage-prescription/${prescriptionId}?isDependent=${dependent}`
  console.log(config.pharmacyURL);
  ...
  const processRowUpdate = (newRow: PrescribedMedicineRow) => {
    ...
    saveMedicineMutation.mutate({ prescriptionId, updatedMedicine, dependent });
