...
import { FormControlLabel, Checkbox, Card, CardContent, Typography, Button } from "@mui/material";
      ...
      <Card key={index} style={{ margin: "8px" }}>
        <CardContent>
          ...
          style={{ marginTop: "8px"}}
            ...
            onClick={() =>
              navigate(
                `family-members/registered/prescriptions/${member.id}`
                )
            }
          >
            View Prescriptions
      ...
      <Card key={index} style={{ margin: "8px",alignContent:'center' }}>
        <CardContent>
          ...
          <Button
            ...
            onClick={() =>
              navigate(
                '/patient/family-members/dependent/prescriptions', { state: { nationalId: member.nationalId }}
                )
            }
          >
            View Prescriptions
