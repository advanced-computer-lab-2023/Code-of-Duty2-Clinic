    ...
    <Box>
      ...
      <Container component="main" maxWidth="md" sx={{ mb: 4 }}>
        ...
        >
          ...
          {step === steps.length ? (
            <React.Fragment>
              <Typography marginTop={4} marginBottom={2} fontWeight={500} color={'#103939'} variant="h5" gutterBottom>
                Thank you for your order.
              </Typography>
              <Typography lineHeight={2} color={'gray'} variant="body1">
                Your payment has been
                successfully processed. If you have any questions or concerns,<br/> please don't hesitate
                to contact our customer support. You can keep track of the order through<br/> El7a2ny Pharmacy
              </Typography>
            </React.Fragment>
          ) : (
