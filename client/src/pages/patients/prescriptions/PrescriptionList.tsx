...
const PrescriptionList: React.FC = () => {
    const { data: prescriptions, isLoading, isError } = useGetPatientPrescriptions();
    ...
    return (
        <>
        <Typography variant='h3' sx={{ textAlign: 'center', marginTop: '3rem', marginBottom: '3rem' }}> My Prescriptions</Typography>
